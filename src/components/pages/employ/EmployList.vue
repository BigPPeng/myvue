  ...
  <div>
    ...
    <el-card>
      <el-table :data="tableData" border style="width: 100%" typle="margin-top: 90px;">
        ...
        <el-table-column label="招聘信息" prop="recruitmentInfoId" />
        <el-table-column label="申请人ID" prop="applicantId" />
        <el-table-column label="申请人姓名" prop="applicantName" />
...
export default {
  ...
  methods: {
    ...
    async getList() {
      ...
      const { data: aa } = await this.$http.post("/api/recruitment/selectRecruitmentApplicationRecordByRecruitmentUserId", { id: userObj.id });   //selectRecruitmentInfoByRecruitmentUserId对不？
      console.log(aa)
